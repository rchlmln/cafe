...
<head>
	...
	<meta name="keywords" content="cafe bahagia">
	<meta name="description" content="website untuk cafe bahagia">
	...
	<script>
		function checkInternetConnection() {
			...
			img.onerror = function() {
				$("#LoadingDulu").html("<div id='InetMatiContent'><i class='fa fa-spinner fa-spin'></i> Tidak Ada Koneksi Internet...</div>");
				$("#LoadingDulu").show();
			};
			img.src = "https://getbootstrap.com/docs/4.0/assets/img/favicons/favicon.ico?" + new Date().getTime();
		}
